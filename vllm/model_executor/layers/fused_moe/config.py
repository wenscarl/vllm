...
class FusedMoEParallelConfig:
    ...
    def use_flashinfer_all2all(self):
        return (self.use_flashinfer_cutlass_kernels
                and self.use_all2all_kernels
                and envs.VLLM_ALL2ALL_BACKEND == "flashinfer_all2all")

    @property
    def use_flashinfer_allgather(self):
        return (self.use_flashinfer_cutlass_kernels
                and self.use_all2all_kernels
                and envs.VLLM_ALL2ALL_BACKEND == "flashinfer_allgather")
